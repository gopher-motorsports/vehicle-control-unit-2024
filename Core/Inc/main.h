...
/* Private defines -----------------------------------------------------------*/
#define FB0_Pin GPIO_PIN_9
#define FB0_GPIO_Port GPIOA
#define FB1_Pin GPIO_PIN_10
#define FB1_GPIO_Port GPIOA
#define FB4_Pin GPIO_PIN_11
#define FB4_GPIO_Port GPIOA
...
#define HARDFAULT_LED_Pin GPIO_PIN_12
#define HARDFAULT_LED_GPIO_Port GPIOC
